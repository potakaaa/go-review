...
export const metadata: Metadata = { title: "Google NFC & QR Tap Card", description: "3×4-inch Google review NFC and QR tap cards for Philippine businesses. ₱299 each, minimum three tap cards.", alternates: { canonical: publicUrl("/google-tap-card") } };
