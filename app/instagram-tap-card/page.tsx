...
export default function InstagramTapCardPage() { return <PlatformTapCardPage platform="Instagram" image="/images/instagram-tap-card-mockup-v1.png" destination="your Instagram profile" accent="#e1306c" />; }
