...
export default async function Home() {
  ...
  return <div>
    ...
    <main id="main">
      ...
      <section data-reveal className={`${container} ${reveal} grid grid-cols-1 gap-7 border-t border-line py-14 md:grid-cols-[1.1fr_.9fr] md:items-center md:gap-16 md:py-20`}><div><p className={kicker}>For sellers and local business partners</p><h2 className={`${heading} mt-5`}>Bring Goreview<br /><span className="display-heading text-muted">to your city.</span></h2></div><div><p className="max-w-md text-[15px] leading-[1.8] text-muted">Buy cards at partner pricing, learn how to set them up, and manage your clients from one private workspace.</p><Link href="/resellers" className={`${textLink} mt-4`}>Explore the reseller program <span aria-hidden="true">↗</span></Link></div></section>
