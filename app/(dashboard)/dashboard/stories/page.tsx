...
export default async function StoriesPage({ searchParams }: { searchParams: Promise<{ saved?: string }> }) {
  ...
  return <div className="mx-auto max-w-3xl"><div className="mb-8 flex flex-wrap items-end justify-between gap-5"><div><p className="eyebrow">Goreview / Website</p><h1 className="display-heading mt-3 text-4xl">Shop stories</h1><p className="mt-3 text-sm text-muted">Real counters. Observed results. Publish when ready.</p></div><ButtonLink href="/dashboard/stories/new">Add story</ButtonLink></div>
