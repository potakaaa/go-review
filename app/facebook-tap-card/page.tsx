...
export default function FacebookTapCardPage() { return <PlatformTapCardPage platform="Facebook" image="/images/facebook-tap-card-mockup-v1.png" destination="your Facebook Page, Reviews, or Recommendations" accent="#1877f2" />; }
